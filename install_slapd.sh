...
echo -e "slapd slapd/domain string clemson.cloudlab" |sudo debconf-set-selections
echo -e "slapd shared/organization string IT410" |sudo debconf-set-selections
